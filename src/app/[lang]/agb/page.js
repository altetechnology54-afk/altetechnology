...
export default async function AGBPage({ params }) {
    ...
    return (
        <main className="min-h-screen bg-white font-sans text-slate-900 py-16 md:py-24 px-4 md:px-12 max-w-[1000px] mx-auto">
            ...
            <div className="space-y-8 text-sm md:text-base text-slate-800 leading-relaxed">
                {/* 1 */}
