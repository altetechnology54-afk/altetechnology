        ...
        <main className="min-h-screen bg-white font-sans text-slate-900 pb-48">
            ...
            <section className="px-4 md:px-12 max-w-7xl mx-auto space-y-20">
                ...
                <div className="bg-slate-50 border border-slate-100 rounded-[60px] p-16 shadow-xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10 max-w-4xl space-y-12">
                        <div className="space-y-6">
                            <p className="text-2xl text-slate-600 font-bold leading-relaxed italic">
                                {getT(sectionData.description).split('\n\n')[0]}
                            </p>
                            <p className="text-xl text-slate-500 font-medium leading-relaxed italic border-l-4 border-slate-200 pl-8">
                                {getT(sectionData.description).split('\n\n')[1]}
                            </p>
                        </div>
                ...
                <div className="bg-white border-2 border-slate-900 rounded-[60px] p-16 shadow-2xl flex flex-col md:flex-row items-center gap-16">
                    ...
                    <div className="flex-1 bg-slate-50 rounded-[40px] p-10 space-y-8">
                        <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em]">
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={i} className="flex items-center gap-4 text-slate-700 font-bold text-lg italic">
